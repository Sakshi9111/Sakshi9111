...
<li> 🧑‍💻I am DevSecOps Engineer.I build and harden cloud-native infrastructure on cloud platform with containerized workloads that run fast, scale clean, and stay secure. Security baked into every pipeline from commit to cluster: automated vulnerability scans, secrets management with zero plaintext, OPA/Gatekeeper policies, and quality gates that catch issues before they ever merge. Shifting left isn't a buzzword — it's architecture. </li>
</ul>
